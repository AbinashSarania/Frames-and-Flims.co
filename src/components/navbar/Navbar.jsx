...
const Navbar = () => {
  ...
  return (
    <nav className="w-full top-0 left-0 z-50 relative">
      ...
      {/* Main Navbar */}
      <div className="bg-[#EFE9DD] flex justify-between items-center px-6 py-4 border-b border-[#7A5A32]">
        <Link to="/" className="font-monsieur text-4xl font-thin text-black z-50">
          Frames and films.co
        </Link>
      ...
      {/* Mobile Menu */}
      <div
        className={`fixed top-[100px] right-0 w-full h-[calc(100vh-100px)] bg-[#EFE9DD] border-t border-[#7A5A32] z-40 transform transition-transform duration-500 ease-in-out ${
